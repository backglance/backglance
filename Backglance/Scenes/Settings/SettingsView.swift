...
///
/// Six tabs. General holds launch at login, the ⌃⌥N hotkey note, Search — semantic indexing
...
/// (docs/features/RULES.md#ui-components, BACKGLANCE-209). Permissions reports what macOS
